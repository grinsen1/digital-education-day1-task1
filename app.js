...
const PLATFORMS_DATA = [
    {
        ...
        "Категория": "OLV",
        "Сайт": "MyTarget",
        "Таргетинг": "РФ, 25-54, Интересы, Ключевые слова, Ретаргетинг",
    ...
    },
    {
        ...
        "Таргетинг": "РФ, 25-54+, Интересы, Ретаргетинг",
        "Формат": "In- stream video (Pre-roll (1920x1080))",
        "Единица закупки": "CPM",
    ...
    },
    {
        ...
        "Категория": "Social Network",
        "Сайт": "Telegram Ads",
        "Таргетинг": "РФ, таргетинг по каналам",
    ...
    },
    {
        ...
        "Категория": "Banners Network",
        "Сайт": "MyTarget",
        "Таргетинг": "РФ, 18-65, Интересы, Ключевые слова, Ретаргетингг",
        "Формат": "Multiformat (1080×607, 600x600)",
        "Единица закупки": "CPC",
        "Стоимость за единицу": "₽80",
        "CPM": "₽176.00",
    ...
    },
    {
        ...
        "Категория": "Banners Network",
        "Сайт": "Iphones.ru",
        "Таргетинг": "Главная страница, внутренние страницы",
    ...
    },
    {
        ...
        "Категория": "Banners Network",
        "Сайт": "Kommersant.ru",
        "Таргетинг": "РФ. На всех страницах, кроме Главной, темы Новости, Война, Криминал",
    ...
    },
    {
        ...
        "Категория": "Banners Network",
        "Сайт": "RBC.ru",
        "Таргетинг": "РФ, Desktop: РБК, Autonews.ru, РБК Стиль, РБК Недвижимость, РБК Инвестиции",
    ...
    },
    {
        ...
        "Сайт": "Ozon.ru",
        "Таргетинг": "РФ, 25-54, Таргетинг на категории",
    ...
    },
    {
        ...
        "Сайт": "Soloway",
        "Таргетинг": "РФ 25-54, Аудиторные сегменты",
...
function createTableRow(platform) {
    ...
    // Основные данные
    const columns = [
        'п/п', 'Категория', 'Сайт', 'Таргетинг', 'Формат', 'Единица закупки', 
